...
export const plan: PlanDefinition = {
  ...
  description: "Review and run each user-story property, then inspect the exact proposed Effect code.",
  stories: [
  ...
  storyTests: [
    { id: "test.create-task", label: "creates every valid generated task as incomplete", storyId: "story.create-task", fileId: "file.test.create-task", relativePath: "src/story-tests/create-task.test.ts", proposedCodeIds: ["code.task-id", "code.task-title", "code.task", "code.create-input", "code.task-service", "code.task-layer", "code.create-task", "code.list-tasks"] },
    { id: "test.list-tasks", label: "lists every generated fixture in its stored order", storyId: "story.list-tasks", fileId: "file.test.list-tasks", relativePath: "src/story-tests/list-tasks.test.ts", proposedCodeIds: ["code.task", "code.task-service", "code.task-layer", "code.list-tasks"] },
    { id: "test.complete-task", label: "completes every generated task without removing it", storyId: "story.complete-task", fileId: "file.test.complete-task", relativePath: "src/story-tests/complete-task.test.ts", proposedCodeIds: ["code.task-id", "code.task-title", "code.task", "code.complete-input", "code.task-service", "code.task-layer", "code.complete-task", "code.list-tasks"] },
  ],
  proposedCode: [
    ...
    { id: "code.task-layer", category: "Service", label: "makeTaskService", fileId: "file.task-service", relativePath: "src/domain/task-service.ts", symbol: "makeTaskService" },
