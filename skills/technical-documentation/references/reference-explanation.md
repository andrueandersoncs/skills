<!--
Extracted from https://diataxis.fr/reference-explanation/ on 2026-09-04.
...
<a id="reference-explanation"></a>
<a id="the-difference-between-reference-and-explanation"></a>
...
<a id="a-straightforward-distinction-mostly"></a>
...
<a id="but-intuition-isn-t-reliable-enough"></a>
...
To help avoid being misled by intuition, see [The compass](compass.md#compass).
