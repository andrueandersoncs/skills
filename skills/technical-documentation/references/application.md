<!--
Extracted from https://diataxis.fr/application/ on 2026-09-04.
...
<a id="applying-diataxis"></a>
# Applying Diátaxis

The pages in this section are concerned with putting Diátaxis into practice.

Diátaxis is underpinned by [systematic theoretical principles](theory.md), but understanding them is not necessary to make effective use of the system.
