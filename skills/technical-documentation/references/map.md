<!--
Extracted from https://diataxis.fr/map/ on 2026-09-04.
...
<a id="the-problem-of-structure"></a>
...
<a id="expectations-and-guidance"></a>
...
| [Tutorials](tutorials.md#tutorials) | [How-to guides](how-to-guides.md#how-to) | [Reference](reference.md#reference) | [Explanation](explanation.md#explanation) |                                       |
| ----------------------------------------------------- | ---------------------------------------------------------- | ----------------------------------------------------- | ----------------------------------------------------------- | ------------------------------------- |
...
![Partial collapse of the structure](https://diataxis.fr/_images/partial-collapse.png) 
...
![Total collapse of the structure](https://diataxis.fr/_images/total-collapse.png) 
...
<a id="the-journey-around-the-map"></a>
...
![Moving around the map](https://diataxis.fr/_images/map-movement.png) 
