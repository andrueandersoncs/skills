<!--
Extracted from https://diataxis.fr/start-here/ on 2026-09-04.
...
<a id="start-here-diataxis-in-five-minutes"></a>
...
<a id="the-four-kinds-of-documentation"></a>
...
* [Tutorials in more detail](tutorials.md#tutorials)
* [Why tutorials are completely different from how-to guides](tutorials-how-to.md#tutorials-how-to)
...
* [How-to guides in more detail](how-to-guides.md#how-to)
...
* [Reference in more detail](reference.md#reference)
...
_Reference material is neutral._ It is not concerned with what the user is doing. A marine chart could be used by a ship’s navigator to plot a course, but equally well by an investigating judge.
...
* [Explanation in more detail](explanation.md#explanation)
* [Understanding the difference between reference and explanation](reference-explanation.md#reference-explanation)
...
* tutorials and explanation serve the _acquisition_ of skill (the user’s **study**)
...
* [The compass in more detail](compass.md#compass)
...
[Diátaxis as a guide to work](how-to-use-diataxis.md#how-to-use-diataxis)
