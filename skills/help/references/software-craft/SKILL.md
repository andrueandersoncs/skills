...
| A Git repository's commit history needs transforming into an evidence-grounded animated story, picture book, or illustrated narrative. | [`animate-git-history`](references/animate-git-history/SKILL.md) |
